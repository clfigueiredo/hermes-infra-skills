...
description: Use quando o aluno precisar do comportamento operacional do agente ECC
  `typescript-reviewer`. Expert TypeScript/JavaScript code reviewer specializing in
  type safety, async correctness, Node/web security, and idiomatic patterns. Use for
  all TypeScript and JavaScript code changes. MUST BE USED for TypeScript/JavaScript
  projects.
version: 1.0.0
...
metadata:
  hermes:
    ...
    - converted-agent
    related_skills: []
    source: https://github.com/affaan-m/ecc/blob/main/agents/typescript-reviewer.md
---

# Agent convertido: Typescript Reviewer

## Visão operacional

Esta skill converte o agente ECC `typescript-reviewer` em um procedimento operacional carregável no Hermes Agent. Use para reproduzir o comportamento do agente dentro da conversa atual, sem depender do mecanismo de agents do ECC/Claude Code.
...
- Agente original: `agents/typescript-reviewer.md`
