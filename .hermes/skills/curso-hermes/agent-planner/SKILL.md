...
description: Use quando o aluno precisar do comportamento operacional do agente ECC
  `planner`. Expert planning specialist for complex features and refactoring. Use
...
# Agent convertido: Planner

## Visão operacional

Esta skill converte o agente ECC `planner` em um procedimento operacional carregável no Hermes Agent. Use para reproduzir o comportamento do agente dentro da conversa atual, sem depender do mecanismo de agents do ECC/Claude Code.
...
- Agente original: `agents/planner.md`
