...
description: Use quando o aluno precisar do comportamento operacional do agente ECC
  `e2e-runner`. End-to-end testing specialist using Vercel Agent Browser (preferred)
...
metadata:
  hermes:
    ...
    - converted-agent
    related_skills: []
    source: https://github.com/affaan-m/ecc/blob/main/agents/e2e-runner.md
---

# Agent convertido: E2E Runner

## Visão operacional

Esta skill converte o agente ECC `e2e-runner` em um procedimento operacional carregável no Hermes Agent. Use para reproduzir o comportamento do agente dentro da conversa atual, sem depender do mecanismo de agents do ECC/Claude Code.
...
- Agente original: `agents/e2e-runner.md`
