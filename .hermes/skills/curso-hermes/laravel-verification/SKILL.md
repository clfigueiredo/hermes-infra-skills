...
Esta skill foi adaptada do projeto MIT `affaan-m/ecc` para uso operacional no Hermes Agent dos alunos.

- Fonte: https://github.com/affaan-m/ecc
- Licença original: MIT
- Ajuste: empacotada em `.hermes/skills/curso-hermes/` sem instaladores, hooks ou automações externas obrigatórias.
