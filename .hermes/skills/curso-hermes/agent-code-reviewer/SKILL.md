...
description: Use quando o aluno precisar do comportamento operacional do agente ECC
  `code-reviewer`. Expert code review specialist. Proactively reviews code for quality,
...
metadata:
  hermes:
    ...
    - converted-agent
    related_skills: []
    source: https://github.com/affaan-m/ecc/blob/main/agents/code-reviewer.md
---

# Agent convertido: Code Reviewer

## Visão operacional

Esta skill converte o agente ECC `code-reviewer` em um procedimento operacional carregável no Hermes Agent. Use para reproduzir o comportamento do agente dentro da conversa atual, sem depender do mecanismo de agents do ECC/Claude Code.
...
- Agente original: `agents/code-reviewer.md`
