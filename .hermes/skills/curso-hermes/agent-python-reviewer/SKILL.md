...
description: Use quando o aluno precisar do comportamento operacional do agente ECC
  `python-reviewer`. Expert Python code reviewer specializing in PEP 8 compliance,
  Pythonic idioms, type hints, security, and performance. Use for all Python code
  changes. MUST BE USED for Python projects.
version: 1.0.0
...
metadata:
  hermes:
    ...
    - converted-agent
    related_skills: []
    source: https://github.com/affaan-m/ecc/blob/main/agents/python-reviewer.md
---

# Agent convertido: Python Reviewer

## Visão operacional

Esta skill converte o agente ECC `python-reviewer` em um procedimento operacional carregável no Hermes Agent. Use para reproduzir o comportamento do agente dentro da conversa atual, sem depender do mecanismo de agents do ECC/Claude Code.
...
- Agente original: `agents/python-reviewer.md`
