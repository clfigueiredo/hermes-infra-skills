...
description: Use quando o aluno precisar do comportamento operacional do agente ECC
  `performance-optimizer`. Performance analysis and optimization specialist. Use PROACTIVELY
  for identifying bottlenecks, optimizing slow code, reducing bundle sizes, and improving
...
metadata:
  hermes:
    ...
    - converted-agent
    related_skills: []
    source: https://github.com/affaan-m/ecc/blob/main/agents/performance-optimizer.md
---

# Agent convertido: Performance Optimizer

## Visão operacional

Esta skill converte o agente ECC `performance-optimizer` em um procedimento operacional carregável no Hermes Agent. Use para reproduzir o comportamento do agente dentro da conversa atual, sem depender do mecanismo de agents do ECC/Claude Code.
...
- Agente original: `agents/performance-optimizer.md`
