...
description: Use quando o aluno precisar do comportamento operacional do agente ECC
  `react-reviewer`. Expert React/JSX code reviewer specializing in hook correctness,
  render performance, server/client component boundaries, accessibility, and React-specific
...
metadata:
  hermes:
    ...
    - converted-agent
    related_skills: []
    source: https://github.com/affaan-m/ecc/blob/main/agents/react-reviewer.md
---

# Agent convertido: React Reviewer

## Visão operacional

Esta skill converte o agente ECC `react-reviewer` em um procedimento operacional carregável no Hermes Agent. Use para reproduzir o comportamento do agente dentro da conversa atual, sem depender do mecanismo de agents do ECC/Claude Code.
...
- Agente original: `agents/react-reviewer.md`
